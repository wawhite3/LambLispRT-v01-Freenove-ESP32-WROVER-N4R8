...
//! (pinMode/digitalWrite/digitalRead/analogWrite/analogRead/tone) with `LLARDUINO=1` and WITHOUT
...
//! `#if LLARDUINO && !LL_ARDUINO`): millis/micros over esp_timer, delay_ms YIELDS via
